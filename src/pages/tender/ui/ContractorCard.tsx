 ...
 *         чтобы шапка таблицы не дёргалась. Место в ранжире — ТОЛЬКО текстом
 *         для скринридера: порядок колонок и их цвет говорят то же самое, но
 *         заливка для скринридера не существует вовсе.
