    ...
    <div className={s.root}>
      ...
      <Popover anchor={at} onClose={() => setAt(null)} label="Легенда пометок">
        <div className={s.body}>
          ...
          <Item
            name="Разброс строки"
            text="Три яруса порога: низкий · заметный · высокий. В колонке ярус несёт тихая заливка ячейки, точное значение — процент текстом; линейкой он подписан у фильтра «Высокий разброс»."
...
function spreadTiers(thresholds: CompareThresholds): ReactNode {
  ...
  /* Образец — ТА ЖЕ линейка, что подписывает предикат «Высокий разброс» в
     «Параметрах», в тех же трёх тонах: словарь показывает знак, который в
     продукте действительно есть, а не абстрактные полоски. Из самой колонки
     глиф снят 25.08.2026 (вечер) — там ярус несёт заливка ячейки. */
  return (
