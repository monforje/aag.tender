...
export const ROWS: TenderRow[] = [
  ...
  /* Тендер, перенесённый из ФКП по архитектурно-художественной подсветке
     (ЖК «АВАНТ», МКД-1/МКД-3). Конец срока — старт + 4 месяца: так отвечают
     условия КП участника №1 в данных сравнения. */
  {
    id: 'T-2026-050', title: 'Устройство АХП в МКД-1, МКД-3',
    portfolio: 'Жилой комплекс «АВАНТ»', project: 'МКД-1 / МКД-3',
    kind: 'Инженерные системы', status: 'open',
    owner: 'Кузнецова Ольга Павловна',
    start: '01.09.2026', end: '31.12.2026', created: '24.08.2026',
  },
];
